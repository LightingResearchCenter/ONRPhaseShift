function errors = batchConvertNoTreatment
...
projectDir = fullfile([filesep,filesep],'root','projects','ONR-PhaseShift');
inputDir = fullfile(projectDir,'dimesimeterData');
outputDir = fullfile(projectDir,'dimesimeterDataNoTreatment');
