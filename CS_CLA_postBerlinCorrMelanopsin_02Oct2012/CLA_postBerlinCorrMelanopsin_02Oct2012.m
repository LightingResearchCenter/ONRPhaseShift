function CLA = CLA_postBerlinCorrMelanopsin_02Oct2012(spd,varargin)
% Revised May 11, 2011
...
Melanopsin = load('MelanopsinWlensBy2nm_02Oct2012.txt');
...
CLA = CS*1622.5; % sets equal to photopic value for 1000 lux of 2856 K
